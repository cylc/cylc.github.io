# Cylc website: How to Contribute

## Report Bugs

Report bugs by opening an issue [on 
Github](https://github.com/cylc/cylc.github.io/issues). Give the version
...
](https://github.com/cylc/cylc.github.io/issues). Describe your use case in
detail.

## Contribute Code

All contributions to project are made via Pull Requests against the *master*
branch of [cylc/cylc.github.io](https://github.com/cylc/cylc.github.io).
Non-trivial developments must be discussed and agreed in advance in a
[Issue](https://github.com/cylc/cylc.github.io/issues) as the team may not
