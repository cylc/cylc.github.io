...
// Create world map.
  var map = new ol.Map({
    ...
    view: new ol.View({
      center: ol.proj.fromLonLat([20, 135].reverse()),
      zoom: 2,
...
// Add each site location as a 'feature' with the name label to display.
  ...
  for (var site of cylcUsingSiteDataByLocation) {
    ...
    var markerAll = new ol.Feature({
      ...
      umPartnerSite: site.umPartnerSite,
...
// Define a style for the site features, including name labels.
  function styleFunction(feature) {
    ...
    } else if (feature.get('umPartnerSite')) {
      colour = cylcColours.green;
      zindex = 1; // plot below non-dev sites but on top of other sites
    };
